...
-- Dumping data for table db_class_reminder.tbl_blast_history: ~20 rows (approximately)
...
-- Dumping data for table db_class_reminder.tbl_event_type: ~3 rows (approximately)
...
-- Dumping data for table db_class_reminder.tbl_trx_log: ~22 rows (approximately)
...
-- Dumping data for table db_class_reminder.tbl_user_event: ~10 rows (approximately)
